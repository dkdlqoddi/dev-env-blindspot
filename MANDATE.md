...
2. Skills MUST delegate exploration and verification to their designated agents (`codebase_scanner`, `domain_researcher`, `doc_verifier`, `change_analyzer`, `check_runner`). Never dump raw exploration output into the main context.
