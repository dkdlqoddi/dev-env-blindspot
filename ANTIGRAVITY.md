...
- Frontmatter contract of all 10 Antigravity subagents (`agents/*.md` with `subagent: true`, `mainAgent: false`, `model: flash`, `commandExecutionPolicy: auto`, and an explicit `tools:` allowlist drawn from the 10 allowed tools).
