...
- Marking a file (신규) in every brief that touches it breaks the resume as soon as the creating 웨이브 commits it — (신규) is judged against the 기준 커밋 and belongs only to the creating task.
