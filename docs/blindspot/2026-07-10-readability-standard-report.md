...
AI가 만들어 주는 다섯 가지 작업 문서(요구사항, 사각지대 점검, 설계 설명서, 작업 보고서, 확인 퀴즈)가 코드를 본 적 없는 사람도 읽을 수 있는 문장으로 나오도록, 각 도구의 지침에 문장 규칙을 심었다. 규칙의 핵심은 두 가지다 — '무슨 일이 벌어지는지'를 쉬운 말로 먼저 쓰고 전문용어는 괄호로 곁들일 것, 그리고 같은 문서 안이라도 읽는 사람이 다른 부분(코드 검토용 안내, AI용 기록, 조사 증거)은 기술 표현을 일부러 그대로 둘 것. 확인 퀴즈에는 문항마다 해설이 생겨 틀린 자리에서 바로 이유를 배울 수 있다. 이미 만들어져 있던 옛 퀴즈와 보고서 요약도 새 기준으로 다시 썼다. 작업은 세 차례로 나눠 진행했고, 매번 설계 승인과 검토, 마지막 전체 검토를 거쳐 반영했다.
